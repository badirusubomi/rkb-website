...
export default function Home() {
	...
	const handleScroll = (event: Any) => {
		// Prevent multiple navigations from firing simultaneously
	...
	return (
		<>
			<div
				ref={screenRef}
				className="w-full min-h-screen flex flex-col bg-[#7d7272] p-0 m-0 overflow-hidden"
			>
				...
				<div className="w-full flex-1 flex flex-row min-h-screen relative">
					...
					>
						...
						<div className="flex flex-col absolute bottom-10 items-center justify-end mb-10 z-10">
					...
					{/* Right Panel */}
					<div className="flex-1 bg-[#5a5656] font-serif flex flex-col justify-between items-center relative min-h-0 overflow-hidden">
						<video
							onClick={handleScroll}
						...
						<div className="flex flex-col items-center justify-end mb-10 absolute bottom-10 z-10">
