...
export default function Portfolio() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen snap-y snap-mandatory">
      ...
      >
        ...
        >
          ...
          >
            <motion.h1 className="text-4xl font-light leading-snug">
              <q>
                A moment of expression where personality becomes art
              </q>
            </motion.h1>
      ...
      >
        ...
        >
          ...
          >
            <motion.h1 className="text-4xl font-light leading-snug">
              <q>
				{he.decode("Confidence&#x2C; presence&#x2C; professionalism captured in a single frame")}
              </q>
            </motion.h1>
      ...
      />
      <Modal isOpen={isModalOpen} onClose={handleClose} pictures={headShots} />
